...
(
    ...
    parameter   DataWidth       =   13;             //This is data width
    parameter   DataDepth       =   256;            //for ASYNC,DataDepth must be 2^n (n>=1). for SYNC,DataDepth is a positive number(>=1), RANGE 4 to 16777216
    parameter   RAMAddWidth     =   8;              //RAM address width
    ...
    sdprf256x13_s sdprf256x13s_inst(
                    .aclr       (aclr                       ),
