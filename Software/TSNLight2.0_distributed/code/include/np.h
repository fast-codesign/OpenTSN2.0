...
#define CONFIG_FILE "./np_app/np.cfg"
#define TSN_CONFIG_FILE "./TSN.cfg"
...
typedef enum
{
	...
	TSN_PTP = 0x30,//tns PTP
	TSN_NMAC = 0x31,//tns NMAC
//	TSN_TSMP = 0x32,//tns TSMP
	TSN_FORWORD_FLOW = 0x32,//tns 转发流
	TSN_HOST_FLOW = 0x33,//tns 终端接收流
	TSN_TIMER = 0x34,
	TSN_REGROUP_FLOW = 0x35,//tns 重组流
	TSN_ARP_FLOW = 0x36, //arp 流
	TSN_TSMP = 0x37,//tns TSMP
	NS_NMAC = 0x50,//ns NMAC
	NS_TAP = 0x51,//ns tap
	NS_FORWORD_FLOW = 0x52,//ns 转发流
}msg_type;
...
typedef enum
{
	...
	PTP_SERVICE_ID = 0x10, //PTP线程
	MAP_SERVICE_ID = 0x11, //映射线程
	TSN_NMAC_SERVICE_ID = 0x12, //TSN nmac线程
	TSN_TSMP_ID = 0x13, //TSN TSMP线程
	TSN_FLOW_BUILD_ID = 0x14, //TSN 流产生线程
	TSN_FLOW_END_ID = 0x15, //TSN 流接收线程
	TSN_TIMER_ID = 0x16, //TSN 定时器线程
	TSN_REGROUP_ID = 0x17, //TSN 重组线程
	TSN_ARP_REPLY_ID = 0x18, //arp reply线程
}service_id;
...
extern void idps_thread(void *argv);
